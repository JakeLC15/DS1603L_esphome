...
################
  - platform: ds1603l
    ...
    ds1603l_min_level: 0.0                       # set minimum level in mm  *default 0.0
    ds1603l_max_level: 600.0                     # set maximum level in mm  *default 1000.0
    ds1603l_min_volume: 0.0                      # set minimum volume in whatever unit_of_measurement you prefer  *default 0.0
    ds1603l_max_volume: 55.0                     # set maximum volume in same unit as min_volume  *default 1000.0
